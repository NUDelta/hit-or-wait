...
#need ordered list for road segment:
        ...
        self.testList = []
        self.testList1 = ['Brummel Street', 'Custer Avenue', 'Mulford Street']
        self.testList2 = ['Brummel Street', 'Custer Avenue', 'Hull Terrace', 'Oakton Street']
        self.testList3 = ['Brummel Street', 'Custer Avenue', 'Austin Street', 'Sherman Avenue']
        self.testList4 = ['Brummel Street', 'Custer Avenue', 'Austin Street', 'Sherman Avenue']
        self.testList5 = ['Brummel Street', 'Custer Avenue', 'Hull Terrace', 'Sherman Avenue']
        self.testList6 = ['Brummel Street', 'Custer Avenue', 'Austin Street', 'Sherman Avenue']
        self.testList7 = ['Brummel Street', 'Custer Avenue', 'Mulford Street', 'Sherman Avenue']
        self.testList8 = ['Brummel Street', 'Custer Avenue', 'Austin Street', 'Sherman Avenue']
        self.testList9 = ['Brummel Street', 'Custer Avenue', 'Case Street', 'Sherman Avenue']
    ...
    def getRoadIntersection(self, currentLat, currentLng):
        ...
        if distanceToIntersection <= 20:
            ...
            currentRoadName = self.getRoadSegments(currentLat,currentLng)
            return currentRoadName, intersectedRoadName
    ...
    def getRoadSegments(self, lat,lng):
    ...
    def loadPreviousHistory(self):
        self.testList.append(self.testList1)
        self.testList.append(self.testList2)
        self.testList.append(self.testList3)
        self.testList.append(self.testList4)
        self.testList.append(self.testList5)
        self.testList.append(self.testList6)
        self.testList.append(self.testList7)
        self.testList.append(self.testList8)
        self.testList.append(self.testList9)

    # given a road segment and previous history
    # output probability of turn taking
    def getNextRoadProb(self, roadName, intersectedRoadName):
        # print self.testList
        # print "test List here"
        currentRoad = roadName
        cnt = 0
        for listItem in self.testList:
            if currentRoad in listItem:
                ...
                # print cases
                if cases in self.testRoadDict:
                    self.testRoadDict[cases] += 1
                else:
                    self.testRoadDict[cases] = 1


        # print testRoadDict
        for key, value in self.testRoadDict.iteritems():
        # do something with value
            self.testRoadDict[key] = float(value)/cnt

        # maxPair = max(testRoadDict.iteritems(), key=operator.itemgetter(1))
        # prob = maxPair[1]

        ####### we need to print out dictionary with probability ####
        # print self.testRoadDict
        return self.testRoadDict
...
#         if getRoadIntersection(currentLat,currentLng) != None:
#             currentRoad, intersection = getRoadIntersection(currentLat,currentLng)
#             roadModel = getNextRoadProb(currentRoad, intersection)
